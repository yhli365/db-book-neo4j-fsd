...
public class OrderedPath {
	private static final RelationshipType R1 = withName("R1"), //
			R2 = withName("R2"), //
			R3 = withName("R3"), //
			R4 = withName("R4"), //
			R5 = withName("R5"); //
	static final File DB_PATH = new File("target/neo4j-db");
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(op.printPaths(op.findPaths(), A));
		System.out.println(op.printPaths(op.findPaths(R2, R5), A));
		op.shutdownGraph();
	}
	...
	public TraversalDescription findPaths(RelationshipType... values) {
